...
# ", avatar: File.new("#{Rails.root}/app/assets/images/mashed_potatoes.jpg"))
...
Ingredient.create(name: "roasted red peppers")
...
Ingredient.create(name: "diced tomatoes in juice")
...
Ingredient.create(name: "prings thyme")
# flat-leaf parsley
